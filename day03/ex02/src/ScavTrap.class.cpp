...
/*   Updated: 2020/07/28 23:03:46 by greed         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::~ScavTrap(){
	std::cout << "*cough *cough <SC4V-TP> " << this->_name <<
		" Why, Lisa, why, WHY?!" << " 'YOU'RE TEARING ME APART, LISA!'" << std::endl;
}

void	ScavTrap::rangedAttack(std::string const &target){
	std::cout << "<SC4V-TP> 'Hey you guys wanna play some football?' " <<
...
void	ScavTrap::takeDamage(unsigned int amount){
	std::cout << "<SC4V-TP> 'Everybody betrayed me!'" << std::endl;
...
void	ScavTrap::beRepaired(unsigned int amount){
	...
	std::cout << "<SC4V-TP> 'You're my favourite customer. Thanks a lot bye!' "
...
void	ScavTrap::challengeNewcomer(std::string const &target){
	...
	this->_energy -= 25;
	std::cout << "<SC4V-TP> takes a sip and prepares for slam poetry! "
